...
import { getAvatarUrl, isAxiosUnprocessableEntityError, setProfileToLS } from '~/utils';
import DateSelect from '../../components/DateSelect';

const schema = yup
  .object({
    name: yup.string().max(160, 'Độ dài từ 5 - 160 ký tự'),
    phone: yup.string().max(20, 'Độ dài từ 6 - 160 ký tự'),
    address: yup.string().max(160, 'Độ dài từ 5 - 160 ký tự'),
    avatar: yup.string().max(1000, 'Độ dài tối đa là 1000 ký tự'),
    date_of_birth: yup.date().max(new Date(), 'Hãy chọn một ngày trong quá khứ')
  })
  .required();

type FormProfile = yup.InferType<typeof schema>;
type FormDataError = Omit<FormProfile, 'date_of_birth'> & {
